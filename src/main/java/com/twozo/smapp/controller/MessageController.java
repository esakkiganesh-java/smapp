...
public class MessageController {
    ...
    @PostMapping("/send")
    public ResponseEntity<?> send(@RequestBody final Message message) {
    ...
    @PutMapping("/edit")
    public ResponseEntity<?> edit(@RequestBody final Message message) {
        ...
        final boolean result = messageService.edit(message, "edit");
    ...
    public ResponseEntity<?> delete(@RequestBody final Message message) {
    ...
    public ResponseEntity<?> getChatHistory(@RequestParam final int senderId,@RequestParam final int receiverId) {
        ...
        final Collection<String> errors = messageValidator.validate(message, ValidationType.CHAT_HISTORY);
