...
public class Message {
    ...
    public Message(final int receiverId,final String content,final int senderId,final String sentTimestamp){
    ...
    public Message(final int id,final int receiverId,final String receiverName,final String content,final int senderId,final String senderName,final String sentTimestamp,final String status){
        this.id = id;
        this.receiverId = receiverId;
