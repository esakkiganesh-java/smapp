...
public class Message {
    ...
    public Message(final int id,final int receiverId,final String receiverName,final String content,final int senderId,final String senderName,final Instant sentTimestamp,final String status){
        this.id = id;
        this.receiverId = receiverId;
